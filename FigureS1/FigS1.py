...
#parameters
a = .014 #decay, 70 ms longer time constant
...
plt.xlim([500, 5000])
plt.ylim([-1, 24])
plt.savefig('Figures/70mspursuit1-leaders-jitterFF.pdf')
...
plt.xlim([500, 5000])
plt.ylim([-1, 24])
plt.savefig('Figures/70mspursuit1-followers-jitterFF.pdf')
...
plt.xlim([8300, 13300])
plt.ylim([-1, 24])
plt.savefig('Figures/70mspursuit2-leaders-jitterFF.pdf')
...
plt.xlim([8300, 13300])
plt.ylim([-1, 24])
plt.savefig('Figures/70mspursuit2-followers-jitterFF.pdf')
...
plt.ylim([-1, 24])
plt.savefig('Figures/70mspursuit3-leaders-jitterFF.pdf')
...
plt.xlim([14900, 22900])
plt.ylim([-1, 24])
plt.savefig('Figures/70mspursuit3-followers-jitterFF.pdf')
...
plt.ylim([-1, 24])
plt.savefig('Figures/70mspursuit4-leaders-jitterFF.pdf')
...
plt.xlim([22500, 28500])
plt.ylim([-1, 24])
plt.savefig('Figures/70mspursuit4-followers-jitterFF.pdf')
...
plt.xlim([500, 5000])
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit1-leadersFF.pdf')
...
plt.xlim([500, 5000])
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit1-followersFF.pdf')
...
plt.xlim([5500, 10300])
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit2-leadersFF.pdf')
...
plt.xlim([5500, 10300])
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit2-followersFF.pdf')
...
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit3-leadersFF.pdf')
...
plt.xlim([12500, 18500])
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit3-followersFF.pdf')
...
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit4-leadersFF.pdf')
...
plt.xlim([19000, 27000])
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit4-followersFF.pdf')
...
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit5-leadersFF.pdf')
...
plt.xlim([28000, 34000])
plt.ylim([-1, 24])
plt.savefig('Figures/70mssaccpursuit5-followersFF.pdf')