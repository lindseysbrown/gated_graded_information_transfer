...
The analysis in Fig. 4 is based on the dataset from So & Shadlen (2022), *Neuron*. This dataset is available at: It is available at: https://data.mendeley.com/datasets/ptcvtxg55j/1.